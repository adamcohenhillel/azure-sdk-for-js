...
export class OpenAIClient {
    ...
    getAudioTranscription<Format extends AudioResultFormat>(deploymentName: string, format: Format, file: Uint8Array | string, options?: GetAudioTranscriptionOptions): Promise<AudioResult<Format>>;
    getAudioTranslation<Format extends AudioResultFormat>(deploymentName: string, format: Format, file: Uint8Array | string, options?: GetAudioTranslationOptions): Promise<AudioResult<Format>>;
